...
## Что сделано
- [x] JSON-API на Flask с блюпринтами, выполненное согласно [ТЗ](./TASK.pdf)
...
Просматривать лог сервиса в реальном времени можно командой `journalctl -b -f -u yandex-demo.service`.
